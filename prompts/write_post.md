...
3. **Comparison/decision** — starts from a technical choice and its trade-offs

Style rules:
- The first line must work as a hook (it's what appears before "see more")
- Paragraphs of 1-2 lines, with spacing
- Tone: technical but accessible, first person, no hype ("revolutionary", "game changer" = forbidden)
